 ...
 * ```
 */
export function elasticsearchIngestProcessorKv(args: ElasticsearchIngestProcessorKvArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorKvResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorKv:ElasticsearchIngestProcessorKv", {
 ...
 */
export interface ElasticsearchIngestProcessorKvArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorKvResult {
    /**
     * Description of the processor.
     */
...
export function elasticsearchIngestProcessorKvOutput(args: ElasticsearchIngestProcessorKvOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorKvResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorKv(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorKv.
 */
export interface ElasticsearchIngestProcessorKvOutputArgs {
    /**
     * Description of the processor.
     */
