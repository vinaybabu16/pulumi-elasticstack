 ...
 * ```
 */
export function elasticsearchIngestProcessorConvert(args: ElasticsearchIngestProcessorConvertArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorConvertResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorConvert:ElasticsearchIngestProcessorConvert", {
 ...
 */
export interface ElasticsearchIngestProcessorConvertResult {
    /**
     * Description of the processor.
     */
...
export function elasticsearchIngestProcessorConvertOutput(args: ElasticsearchIngestProcessorConvertOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorConvertResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorConvert(a, opts))
}
