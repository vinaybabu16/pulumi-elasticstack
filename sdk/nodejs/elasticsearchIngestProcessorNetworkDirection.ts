 ...
 * ```
 */
export function elasticsearchIngestProcessorNetworkDirection(args?: ElasticsearchIngestProcessorNetworkDirectionArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorNetworkDirectionResult> {
    args = args || {};
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorNetworkDirection:ElasticsearchIngestProcessorNetworkDirection", {
 ...
 */
export interface ElasticsearchIngestProcessorNetworkDirectionArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorNetworkDirectionResult {
    /**
     * Description of the processor.
     */
...
export function elasticsearchIngestProcessorNetworkDirectionOutput(args?: ElasticsearchIngestProcessorNetworkDirectionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorNetworkDirectionResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorNetworkDirection(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorNetworkDirection.
 */
export interface ElasticsearchIngestProcessorNetworkDirectionOutputArgs {
    /**
     * Description of the processor.
     */
