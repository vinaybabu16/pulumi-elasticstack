 ...
 * ```
 */
export function elasticsearchIngestProcessorCommunityId(args?: ElasticsearchIngestProcessorCommunityIdArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorCommunityIdResult> {
    args = args || {};
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorCommunityId:ElasticsearchIngestProcessorCommunityId", {
 ...
 */
export interface ElasticsearchIngestProcessorCommunityIdArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorCommunityIdResult {
    /**
     * Description of the processor.
     */
...
export function elasticsearchIngestProcessorCommunityIdOutput(args?: ElasticsearchIngestProcessorCommunityIdOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorCommunityIdResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorCommunityId(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorCommunityId.
 */
export interface ElasticsearchIngestProcessorCommunityIdOutputArgs {
    /**
     * Description of the processor.
     */
