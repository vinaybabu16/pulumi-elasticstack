 ...
 * ```
 */
export function elasticsearchIngestProcessorDate(args: ElasticsearchIngestProcessorDateArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorDateResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorDate:ElasticsearchIngestProcessorDate", {
 ...
 */
export interface ElasticsearchIngestProcessorDateArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorDateResult {
    /**
     * Description of the processor.
     */
...
export function elasticsearchIngestProcessorDateOutput(args: ElasticsearchIngestProcessorDateOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorDateResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorDate(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorDate.
 */
export interface ElasticsearchIngestProcessorDateOutputArgs {
    /**
     * Description of the processor.
     */
