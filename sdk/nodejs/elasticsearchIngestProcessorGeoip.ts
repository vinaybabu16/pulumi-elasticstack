 ...
 * ```
 */
export function elasticsearchIngestProcessorGeoip(args: ElasticsearchIngestProcessorGeoipArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorGeoipResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorGeoip:ElasticsearchIngestProcessorGeoip", {
 ...
 */
export interface ElasticsearchIngestProcessorGeoipArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorGeoipResult {
    /**
     * The database filename referring to a database the module ships with (GeoLite2-City.mmdb, GeoLite2-Country.mmdb, or GeoLite2-ASN.mmdb) or a custom database in the `ingest-geoip` config directory.
     */
...
export function elasticsearchIngestProcessorGeoipOutput(args: ElasticsearchIngestProcessorGeoipOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorGeoipResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorGeoip(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorGeoip.
 */
export interface ElasticsearchIngestProcessorGeoipOutputArgs {
    /**
     * The database filename referring to a database the module ships with (GeoLite2-City.mmdb, GeoLite2-Country.mmdb, or GeoLite2-ASN.mmdb) or a custom database in the `ingest-geoip` config directory.
     */
