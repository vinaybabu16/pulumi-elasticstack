 ...
 * ```
 */
export function elasticsearchIngestProcessorJoin(args: ElasticsearchIngestProcessorJoinArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorJoinResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorJoin:ElasticsearchIngestProcessorJoin", {
 ...
 */
export interface ElasticsearchIngestProcessorJoinArgs {
    /**
...
export function elasticsearchIngestProcessorJoinOutput(args: ElasticsearchIngestProcessorJoinOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorJoinResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorJoin(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorJoin.
 */
export interface ElasticsearchIngestProcessorJoinOutputArgs {
    /**
     * Description of the processor.
     */
