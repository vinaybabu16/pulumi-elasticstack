 ...
 * ```
 */
export function elasticsearchIngestProcessorUserAgent(args: ElasticsearchIngestProcessorUserAgentArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorUserAgentResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorUserAgent:ElasticsearchIngestProcessorUserAgent", {
 ...
 */
export interface ElasticsearchIngestProcessorUserAgentArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorUserAgentResult {
    /**
     * Extracts device type from the user agent string on a best-effort basis. Supported only starting from Elasticsearch version **8.0**
     */
...
export function elasticsearchIngestProcessorUserAgentOutput(args: ElasticsearchIngestProcessorUserAgentOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorUserAgentResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorUserAgent(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorUserAgent.
 */
export interface ElasticsearchIngestProcessorUserAgentOutputArgs {
    /**
     * Extracts device type from the user agent string on a best-effort basis. Supported only starting from Elasticsearch version **8.0**
     */
