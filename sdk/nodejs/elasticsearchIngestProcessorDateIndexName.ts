 ...
 * ```
 */
export function elasticsearchIngestProcessorDateIndexName(args: ElasticsearchIngestProcessorDateIndexNameArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorDateIndexNameResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorDateIndexName:ElasticsearchIngestProcessorDateIndexName", {
 ...
 */
export interface ElasticsearchIngestProcessorDateIndexNameArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorDateIndexNameResult {
    /**
     * An array of the expected date formats for parsing dates / timestamps in the document being preprocessed.
     */
...
export function elasticsearchIngestProcessorDateIndexNameOutput(args: ElasticsearchIngestProcessorDateIndexNameOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorDateIndexNameResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorDateIndexName(a, opts))
}
