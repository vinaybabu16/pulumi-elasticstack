 ...
 * ```
 */
export function elasticsearchIngestProcessorBytes(args: ElasticsearchIngestProcessorBytesArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorBytesResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorBytes:ElasticsearchIngestProcessorBytes", {
 ...
 */
export interface ElasticsearchIngestProcessorBytesArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorBytesResult {
    /**
     * Description of the processor.
     */
...
export function elasticsearchIngestProcessorBytesOutput(args: ElasticsearchIngestProcessorBytesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorBytesResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorBytes(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorBytes.
 */
export interface ElasticsearchIngestProcessorBytesOutputArgs {
    /**
     * Description of the processor.
     */
