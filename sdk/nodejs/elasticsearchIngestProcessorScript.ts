 ...
 */
export function elasticsearchIngestProcessorScript(args?: ElasticsearchIngestProcessorScriptArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorScriptResult> {
    args = args || {};
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorScript:ElasticsearchIngestProcessorScript", {
 ...
 */
export interface ElasticsearchIngestProcessorScriptArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorScriptResult {
    /**
     * Description of the processor.
     */
...
export function elasticsearchIngestProcessorScriptOutput(args?: ElasticsearchIngestProcessorScriptOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorScriptResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorScript(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorScript.
 */
export interface ElasticsearchIngestProcessorScriptOutputArgs {
    /**
     * Description of the processor.
     */
