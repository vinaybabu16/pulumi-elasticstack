 ...
 * ```
 */
export function elasticsearchIngestProcessorFingerprint(args: ElasticsearchIngestProcessorFingerprintArgs, opts?: pulumi.InvokeOptions): Promise<ElasticsearchIngestProcessorFingerprintResult> {
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("elasticstack:index/elasticsearchIngestProcessorFingerprint:ElasticsearchIngestProcessorFingerprint", {
 ...
 */
export interface ElasticsearchIngestProcessorFingerprintArgs {
    /**
 ...
 */
export interface ElasticsearchIngestProcessorFingerprintResult {
    /**
     * Description of the processor.
     */
...
export function elasticsearchIngestProcessorFingerprintOutput(args: ElasticsearchIngestProcessorFingerprintOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<ElasticsearchIngestProcessorFingerprintResult> {
    return pulumi.output(args).apply(a => elasticsearchIngestProcessorFingerprint(a, opts))
}

/**
 * A collection of arguments for invoking ElasticsearchIngestProcessorFingerprint.
 */
export interface ElasticsearchIngestProcessorFingerprintOutputArgs {
    /**
     * Description of the processor.
     */
