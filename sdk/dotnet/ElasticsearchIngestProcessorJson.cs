...
{
    public static class ElasticsearchIngestProcessorJson
    {
        /// <summary>
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<ElasticsearchIngestProcessorJsonResult> InvokeAsync(ElasticsearchIngestProcessorJsonArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ElasticsearchIngestProcessorJsonResult>("elasticstack:index/elasticsearchIngestProcessorJson:ElasticsearchIngestProcessorJson", args ?? new ElasticsearchIngestProcessorJsonArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<ElasticsearchIngestProcessorJsonResult> Invoke(ElasticsearchIngestProcessorJsonInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ElasticsearchIngestProcessorJsonResult>("elasticstack:index/elasticsearchIngestProcessorJson:ElasticsearchIngestProcessorJson", args ?? new ElasticsearchIngestProcessorJsonInvokeArgs(), options.WithDefaults());
    }


    public sealed class ElasticsearchIngestProcessorJsonArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public ElasticsearchIngestProcessorJsonArgs()
        {
        }
    }

    public sealed class ElasticsearchIngestProcessorJsonInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// Flag that forces the parsed JSON to be added at the top level of the document. `target_field` must not be set when this option is chosen.
        /// </summary>
        ...
        public ElasticsearchIngestProcessorJsonInvokeArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class ElasticsearchIngestProcessorJsonResult
    {
        /// <summary>
        /// Flag that forces the parsed JSON to be added at the top level of the document. `target_field` must not be set when this option is chosen.
        /// </summary>
        ...
        [OutputConstructor]
        private ElasticsearchIngestProcessorJsonResult(
            bool? addToRoot,
