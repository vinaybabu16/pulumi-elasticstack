...
{
    public static class ElasticsearchIngestProcessorSet
    {
        /// <summary>
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<ElasticsearchIngestProcessorSetResult> InvokeAsync(ElasticsearchIngestProcessorSetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ElasticsearchIngestProcessorSetResult>("elasticstack:index/elasticsearchIngestProcessorSet:ElasticsearchIngestProcessorSet", args ?? new ElasticsearchIngestProcessorSetArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<ElasticsearchIngestProcessorSetResult> Invoke(ElasticsearchIngestProcessorSetInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ElasticsearchIngestProcessorSetResult>("elasticstack:index/elasticsearchIngestProcessorSet:ElasticsearchIngestProcessorSet", args ?? new ElasticsearchIngestProcessorSetInvokeArgs(), options.WithDefaults());
    }


    public sealed class ElasticsearchIngestProcessorSetArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public ElasticsearchIngestProcessorSetArgs()
        {
        }
    }

    public sealed class ElasticsearchIngestProcessorSetInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The origin field which will be copied to `field`, cannot set `value` simultaneously.
        /// </summary>
        ...
        public ElasticsearchIngestProcessorSetInvokeArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class ElasticsearchIngestProcessorSetResult
    {
        /// <summary>
        /// The origin field which will be copied to `field`, cannot set `value` simultaneously.
        /// </summary>
        ...
        [OutputConstructor]
        private ElasticsearchIngestProcessorSetResult(
            string? copyFrom,
