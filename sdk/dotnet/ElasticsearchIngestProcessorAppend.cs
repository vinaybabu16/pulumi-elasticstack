...
{
    public static class ElasticsearchIngestProcessorAppend
    {
        /// <summary>
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<ElasticsearchIngestProcessorAppendResult> InvokeAsync(ElasticsearchIngestProcessorAppendArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ElasticsearchIngestProcessorAppendResult>("elasticstack:index/elasticsearchIngestProcessorAppend:ElasticsearchIngestProcessorAppend", args ?? new ElasticsearchIngestProcessorAppendArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<ElasticsearchIngestProcessorAppendResult> Invoke(ElasticsearchIngestProcessorAppendInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ElasticsearchIngestProcessorAppendResult>("elasticstack:index/elasticsearchIngestProcessorAppend:ElasticsearchIngestProcessorAppend", args ?? new ElasticsearchIngestProcessorAppendInvokeArgs(), options.WithDefaults());
    }


    public sealed class ElasticsearchIngestProcessorAppendArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public ElasticsearchIngestProcessorAppendArgs()
        {
        }
    }

    public sealed class ElasticsearchIngestProcessorAppendInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// If `false`, the processor does not append values already present in the field.
        /// </summary>
        ...
        public ElasticsearchIngestProcessorAppendInvokeArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class ElasticsearchIngestProcessorAppendResult
    {
        /// <summary>
        /// If `false`, the processor does not append values already present in the field.
        /// </summary>
        ...
        [OutputConstructor]
        private ElasticsearchIngestProcessorAppendResult(
