...
namespace Pulumi.Elasticstack.Inputs
{
    ...
    public sealed class ElasticsearchIndexLifecycleHotArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Force merges the index into the specified maximum number of segments. This action makes the index read-only.
        /// </summary>
        [Input("forcemerge")]
        public Input<Inputs.ElasticsearchIndexLifecycleHotForcemergeArgs>? Forcemerge { get; set; }
        ...
        /// </summary>
        [Input("readonly")]
        public Input<Inputs.ElasticsearchIndexLifecycleHotReadonlyArgs>? Readonly { get; set; }

        /// <summary>
        /// Rolls over a target to a new index when the existing index meets one or more of the rollover conditions.
        /// </summary>
        [Input("rollover")]
        public Input<Inputs.ElasticsearchIndexLifecycleHotRolloverArgs>? Rollover { get; set; }
        ...
        public Input<Inputs.ElasticsearchIndexLifecycleHotSearchableSnapshotArgs>? SearchableSnapshot { get; set; }

        /// <summary>
        /// Sets a source index to read-only and shrinks it into a new index with fewer primary shards.
        /// </summary>
        [Input("setPriority")]
        public Input<Inputs.ElasticsearchIndexLifecycleHotSetPriorityArgs>? SetPriority { get; set; }

        /// <summary>
        /// Sets a source index to read-only and shrinks it into a new index with fewer primary shards.
        /// </summary>
        [Input("shrink")]
        public Input<Inputs.ElasticsearchIndexLifecycleHotShrinkArgs>? Shrink { get; set; }
        ...
        /// </summary>
        [Input("unfollow")]
        public Input<Inputs.ElasticsearchIndexLifecycleHotUnfollowArgs>? Unfollow { get; set; }

        public ElasticsearchIndexLifecycleHotArgs()
        {
        }
    }
}
