...
namespace Pulumi.Elasticstack.Inputs
{
    ...
    public sealed class ElasticsearchIndexLifecycleDeleteGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Permanently removes the index.
        /// </summary>
        [Input("delete")]
        public Input<Inputs.ElasticsearchIndexLifecycleDeleteDeleteGetArgs>? Delete { get; set; }
        ...
        public Input<Inputs.ElasticsearchIndexLifecycleDeleteWaitForSnapshotGetArgs>? WaitForSnapshot { get; set; }

        public ElasticsearchIndexLifecycleDeleteGetArgs()
        {
        }
    }
}
