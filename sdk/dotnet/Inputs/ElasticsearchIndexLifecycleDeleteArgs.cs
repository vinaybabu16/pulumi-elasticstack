...
namespace Pulumi.Elasticstack.Inputs
{
    ...
    public sealed class ElasticsearchIndexLifecycleDeleteArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Permanently removes the index.
        /// </summary>
        [Input("delete")]
        public Input<Inputs.ElasticsearchIndexLifecycleDeleteDeleteArgs>? Delete { get; set; }
        ...
        public Input<Inputs.ElasticsearchIndexLifecycleDeleteWaitForSnapshotArgs>? WaitForSnapshot { get; set; }

        public ElasticsearchIndexLifecycleDeleteArgs()
        {
        }
    }
}
