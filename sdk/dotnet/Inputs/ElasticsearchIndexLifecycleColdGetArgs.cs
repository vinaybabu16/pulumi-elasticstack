...
namespace Pulumi.Elasticstack.Inputs
{
    ...
    public sealed class ElasticsearchIndexLifecycleColdGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Updates the index settings to change which nodes are allowed to host the index shards and change the number of replicas.
        /// </summary>
        [Input("allocate")]
        public Input<Inputs.ElasticsearchIndexLifecycleColdAllocateGetArgs>? Allocate { get; set; }

        /// <summary>
        /// Freeze the index to minimize its memory footprint.
        /// </summary>
        [Input("freeze")]
        public Input<Inputs.ElasticsearchIndexLifecycleColdFreezeGetArgs>? Freeze { get; set; }
        ...
        /// </summary>
        [Input("migrate")]
        public Input<Inputs.ElasticsearchIndexLifecycleColdMigrateGetArgs>? Migrate { get; set; }
        ...
        /// </summary>
        [Input("readonly")]
        public Input<Inputs.ElasticsearchIndexLifecycleColdReadonlyGetArgs>? Readonly { get; set; }
        ...
        public Input<Inputs.ElasticsearchIndexLifecycleColdSearchableSnapshotGetArgs>? SearchableSnapshot { get; set; }

        /// <summary>
        /// Sets a source index to read-only and shrinks it into a new index with fewer primary shards.
        /// </summary>
        [Input("setPriority")]
        public Input<Inputs.ElasticsearchIndexLifecycleColdSetPriorityGetArgs>? SetPriority { get; set; }
        ...
        /// </summary>
        [Input("unfollow")]
        public Input<Inputs.ElasticsearchIndexLifecycleColdUnfollowGetArgs>? Unfollow { get; set; }

        public ElasticsearchIndexLifecycleColdGetArgs()
        {
        }
    }
}
