...
{
    public static class ElasticsearchIngestProcessorGeoip
    {
        /// <summary>
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<ElasticsearchIngestProcessorGeoipResult> InvokeAsync(ElasticsearchIngestProcessorGeoipArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<ElasticsearchIngestProcessorGeoipResult>("elasticstack:index/elasticsearchIngestProcessorGeoip:ElasticsearchIngestProcessorGeoip", args ?? new ElasticsearchIngestProcessorGeoipArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<ElasticsearchIngestProcessorGeoipResult> Invoke(ElasticsearchIngestProcessorGeoipInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<ElasticsearchIngestProcessorGeoipResult>("elasticstack:index/elasticsearchIngestProcessorGeoip:ElasticsearchIngestProcessorGeoip", args ?? new ElasticsearchIngestProcessorGeoipInvokeArgs(), options.WithDefaults());
    }


    public sealed class ElasticsearchIngestProcessorGeoipArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public ElasticsearchIngestProcessorGeoipArgs()
        {
        }
    }

    public sealed class ElasticsearchIngestProcessorGeoipInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The database filename referring to a database the module ships with (GeoLite2-City.mmdb, GeoLite2-Country.mmdb, or GeoLite2-ASN.mmdb) or a custom database in the `ingest-geoip` config directory.
        /// </summary>
        ...
        public ElasticsearchIngestProcessorGeoipInvokeArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class ElasticsearchIngestProcessorGeoipResult
    {
        /// <summary>
        /// The database filename referring to a database the module ships with (GeoLite2-City.mmdb, GeoLite2-Country.mmdb, or GeoLite2-ASN.mmdb) or a custom database in the `ingest-geoip` config directory.
        /// </summary>
        ...
        [OutputConstructor]
        private ElasticsearchIngestProcessorGeoipResult(
            string? databaseFile,
