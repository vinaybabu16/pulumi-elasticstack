...
__all__ = [
    'ElasticsearchIngestProcessorSplitResult',
    'AwaitableElasticsearchIngestProcessorSplitResult',
    'elasticsearch_ingest_processor_split',
    'elasticsearch_ingest_processor_split_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorSplitResult:
    """
...
class AwaitableElasticsearchIngestProcessorSplitResult(ElasticsearchIngestProcessorSplitResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorSplitResult(
...
def elasticsearch_ingest_processor_split(description: Optional[str] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorSplitResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorSplit:ElasticsearchIngestProcessorSplit', __args__, opts=opts, typ=ElasticsearchIngestProcessorSplitResult).value

    return AwaitableElasticsearchIngestProcessorSplitResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_split)
def elasticsearch_ingest_processor_split_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorSplitResult]:
    """
    Splits a field into an array using a separator character. Only works on string fields.
