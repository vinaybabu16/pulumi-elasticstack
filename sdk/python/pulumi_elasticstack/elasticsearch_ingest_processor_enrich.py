...
__all__ = [
    'ElasticsearchIngestProcessorEnrichResult',
    'AwaitableElasticsearchIngestProcessorEnrichResult',
    'elasticsearch_ingest_processor_enrich',
    'elasticsearch_ingest_processor_enrich_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorEnrichResult:
    """
...
class AwaitableElasticsearchIngestProcessorEnrichResult(ElasticsearchIngestProcessorEnrichResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorEnrichResult(
...
def elasticsearch_ingest_processor_enrich(description: Optional[str] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorEnrichResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorEnrich:ElasticsearchIngestProcessorEnrich', __args__, opts=opts, typ=ElasticsearchIngestProcessorEnrichResult).value

    return AwaitableElasticsearchIngestProcessorEnrichResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_enrich)
def elasticsearch_ingest_processor_enrich_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                 ...
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorEnrichResult]:
    """
    The enrich processor can enrich documents with data from another index. See enrich data section for more information about how to set this up.
