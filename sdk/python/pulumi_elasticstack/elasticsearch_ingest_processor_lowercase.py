...
__all__ = [
    'ElasticsearchIngestProcessorLowercaseResult',
    'AwaitableElasticsearchIngestProcessorLowercaseResult',
    'elasticsearch_ingest_processor_lowercase',
    'elasticsearch_ingest_processor_lowercase_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorLowercaseResult:
    """
...
class AwaitableElasticsearchIngestProcessorLowercaseResult(ElasticsearchIngestProcessorLowercaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorLowercaseResult(
...
def elasticsearch_ingest_processor_lowercase(description: Optional[str] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorLowercaseResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorLowercase:ElasticsearchIngestProcessorLowercase', __args__, opts=opts, typ=ElasticsearchIngestProcessorLowercaseResult).value

    return AwaitableElasticsearchIngestProcessorLowercaseResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_lowercase)
def elasticsearch_ingest_processor_lowercase_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                    ...
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorLowercaseResult]:
    """
    Converts a string to its lowercase equivalent. If the field is an array of strings, all members of the array will be converted.
