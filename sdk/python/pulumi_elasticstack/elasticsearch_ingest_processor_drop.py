...
__all__ = [
    'ElasticsearchIngestProcessorDropResult',
    'AwaitableElasticsearchIngestProcessorDropResult',
    'elasticsearch_ingest_processor_drop',
    'elasticsearch_ingest_processor_drop_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorDropResult:
    """
...
class AwaitableElasticsearchIngestProcessorDropResult(ElasticsearchIngestProcessorDropResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorDropResult(
...
def elasticsearch_ingest_processor_drop(description: Optional[str] = None,
                                        if_: Optional[str] = None,
                                        ignore_failure: Optional[bool] = None,
                                        on_failures: Optional[Sequence[str]] = None,
                                        tag: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorDropResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorDrop:ElasticsearchIngestProcessorDrop', __args__, opts=opts, typ=ElasticsearchIngestProcessorDropResult).value

    return AwaitableElasticsearchIngestProcessorDropResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_drop)
def elasticsearch_ingest_processor_drop_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorDropResult]:
    """
    Drops the document without raising any errors. This is useful to prevent the document from getting indexed based on some condition.
