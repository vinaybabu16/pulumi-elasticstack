...
__all__ = [
    'ElasticsearchIngestProcessorDateResult',
    'AwaitableElasticsearchIngestProcessorDateResult',
    'elasticsearch_ingest_processor_date',
    'elasticsearch_ingest_processor_date_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorDateResult:
    """
...
class AwaitableElasticsearchIngestProcessorDateResult(ElasticsearchIngestProcessorDateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorDateResult(
...
def elasticsearch_ingest_processor_date(description: Optional[str] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorDateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorDate:ElasticsearchIngestProcessorDate', __args__, opts=opts, typ=ElasticsearchIngestProcessorDateResult).value

    return AwaitableElasticsearchIngestProcessorDateResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_date)
def elasticsearch_ingest_processor_date_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorDateResult]:
    """
    Helper data source to which can be used to parse dates from fields, and then uses the date or timestamp as the timestamp for the document.
    By default, the date processor adds the parsed date as a new field called `@timestamp`. You can specify a different field by setting the `target_field` configuration parameter. Multiple date formats are supported as part of the same date processor definition. They will be used sequentially to attempt parsing the date field, in the same order they were defined as part of the processor definition.
