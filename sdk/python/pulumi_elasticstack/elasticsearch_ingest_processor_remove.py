...
__all__ = [
    'ElasticsearchIngestProcessorRemoveResult',
    'AwaitableElasticsearchIngestProcessorRemoveResult',
    'elasticsearch_ingest_processor_remove',
    'elasticsearch_ingest_processor_remove_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorRemoveResult:
    """
...
class AwaitableElasticsearchIngestProcessorRemoveResult(ElasticsearchIngestProcessorRemoveResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorRemoveResult(
...
def elasticsearch_ingest_processor_remove(description: Optional[str] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorRemoveResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorRemove:ElasticsearchIngestProcessorRemove', __args__, opts=opts, typ=ElasticsearchIngestProcessorRemoveResult).value

    return AwaitableElasticsearchIngestProcessorRemoveResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_remove)
def elasticsearch_ingest_processor_remove_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                 ...
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorRemoveResult]:
    """
    Removes existing fields. If one field doesn’t exist, an exception will be thrown.
