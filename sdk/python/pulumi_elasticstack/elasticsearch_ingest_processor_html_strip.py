...
__all__ = [
    'ElasticsearchIngestProcessorHtmlStripResult',
    'AwaitableElasticsearchIngestProcessorHtmlStripResult',
    'elasticsearch_ingest_processor_html_strip',
    'elasticsearch_ingest_processor_html_strip_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorHtmlStripResult:
    """
...
class AwaitableElasticsearchIngestProcessorHtmlStripResult(ElasticsearchIngestProcessorHtmlStripResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorHtmlStripResult(
...
def elasticsearch_ingest_processor_html_strip(description: Optional[str] = None,
                                              ...
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorHtmlStripResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorHtmlStrip:ElasticsearchIngestProcessorHtmlStrip', __args__, opts=opts, typ=ElasticsearchIngestProcessorHtmlStripResult).value

    return AwaitableElasticsearchIngestProcessorHtmlStripResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_html_strip)
def elasticsearch_ingest_processor_html_strip_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                     ...
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorHtmlStripResult]:
    """
    Removes HTML tags from the field. If the field is an array of strings, HTML tags will be removed from all members of the array.
