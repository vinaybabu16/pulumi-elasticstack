...
__all__ = [
    'ElasticsearchIngestProcessorDateIndexNameResult',
    'AwaitableElasticsearchIngestProcessorDateIndexNameResult',
    'elasticsearch_ingest_processor_date_index_name',
    'elasticsearch_ingest_processor_date_index_name_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorDateIndexNameResult:
    """
...
class AwaitableElasticsearchIngestProcessorDateIndexNameResult(ElasticsearchIngestProcessorDateIndexNameResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorDateIndexNameResult(
...
def elasticsearch_ingest_processor_date_index_name(date_formats: Optional[Sequence[str]] = None,
                                                   ...
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorDateIndexNameResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorDateIndexName:ElasticsearchIngestProcessorDateIndexName', __args__, opts=opts, typ=ElasticsearchIngestProcessorDateIndexNameResult).value

    return AwaitableElasticsearchIngestProcessorDateIndexNameResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_date_index_name)
def elasticsearch_ingest_processor_date_index_name_output(date_formats: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                                          ...
                                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorDateIndexNameResult]:
    """
    The purpose of this processor is to point documents to the right time based index based on a date or timestamp field in a document by using the date math index name support.
