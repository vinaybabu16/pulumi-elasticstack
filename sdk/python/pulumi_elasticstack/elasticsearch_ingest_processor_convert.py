...
__all__ = [
    'ElasticsearchIngestProcessorConvertResult',
    'AwaitableElasticsearchIngestProcessorConvertResult',
    'elasticsearch_ingest_processor_convert',
    'elasticsearch_ingest_processor_convert_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorConvertResult:
    """
...
class AwaitableElasticsearchIngestProcessorConvertResult(ElasticsearchIngestProcessorConvertResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorConvertResult(
...
def elasticsearch_ingest_processor_convert(description: Optional[str] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorConvertResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorConvert:ElasticsearchIngestProcessorConvert', __args__, opts=opts, typ=ElasticsearchIngestProcessorConvertResult).value

    return AwaitableElasticsearchIngestProcessorConvertResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_convert)
def elasticsearch_ingest_processor_convert_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                  ...
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorConvertResult]:
    """
    Helper data source to which can be used to convert a field in the currently ingested document to a different type, such as converting a string to an integer. If the field value is an array, all members will be converted.
