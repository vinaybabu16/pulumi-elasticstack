...
__all__ = [
    'ElasticsearchIngestProcessorGsubResult',
    'AwaitableElasticsearchIngestProcessorGsubResult',
    'elasticsearch_ingest_processor_gsub',
    'elasticsearch_ingest_processor_gsub_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorGsubResult:
    """
...
class AwaitableElasticsearchIngestProcessorGsubResult(ElasticsearchIngestProcessorGsubResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorGsubResult(
...
def elasticsearch_ingest_processor_gsub(description: Optional[str] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorGsubResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorGsub:ElasticsearchIngestProcessorGsub', __args__, opts=opts, typ=ElasticsearchIngestProcessorGsubResult).value

    return AwaitableElasticsearchIngestProcessorGsubResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_gsub)
def elasticsearch_ingest_processor_gsub_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorGsubResult]:
    """
    Converts a string field by applying a regular expression and a replacement. If the field is an array of string, all members of the array will be converted. If any non-string values are encountered, the processor will throw an exception.
