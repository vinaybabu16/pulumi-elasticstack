...
__all__ = [
    'ElasticsearchIngestProcessorRegisteredDomainResult',
    'AwaitableElasticsearchIngestProcessorRegisteredDomainResult',
    'elasticsearch_ingest_processor_registered_domain',
    'elasticsearch_ingest_processor_registered_domain_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorRegisteredDomainResult:
    """
...
class AwaitableElasticsearchIngestProcessorRegisteredDomainResult(ElasticsearchIngestProcessorRegisteredDomainResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorRegisteredDomainResult(
...
def elasticsearch_ingest_processor_registered_domain(description: Optional[str] = None,
                                                     ...
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorRegisteredDomainResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorRegisteredDomain:ElasticsearchIngestProcessorRegisteredDomain', __args__, opts=opts, typ=ElasticsearchIngestProcessorRegisteredDomainResult).value

    return AwaitableElasticsearchIngestProcessorRegisteredDomainResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_registered_domain)
def elasticsearch_ingest_processor_registered_domain_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                            ...
                                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorRegisteredDomainResult]:
    """
    Extracts the registered domain (also known as the effective top-level domain or eTLD), sub-domain, and top-level domain from a fully qualified domain name (FQDN). Uses the registered domains defined in the Mozilla Public Suffix List.
