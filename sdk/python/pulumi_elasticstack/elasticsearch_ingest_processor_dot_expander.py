...
__all__ = [
    'ElasticsearchIngestProcessorDotExpanderResult',
    'AwaitableElasticsearchIngestProcessorDotExpanderResult',
    'elasticsearch_ingest_processor_dot_expander',
    'elasticsearch_ingest_processor_dot_expander_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorDotExpanderResult:
    """
...
class AwaitableElasticsearchIngestProcessorDotExpanderResult(ElasticsearchIngestProcessorDotExpanderResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorDotExpanderResult(
...
def elasticsearch_ingest_processor_dot_expander(description: Optional[str] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorDotExpanderResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorDotExpander:ElasticsearchIngestProcessorDotExpander', __args__, opts=opts, typ=ElasticsearchIngestProcessorDotExpanderResult).value

    return AwaitableElasticsearchIngestProcessorDotExpanderResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_dot_expander)
def elasticsearch_ingest_processor_dot_expander_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                       ...
                                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorDotExpanderResult]:
    """
    Expands a field with dots into an object field. This processor allows fields with dots in the name to be accessible by other processors in the pipeline. Otherwise these fields can’t be accessed by any processor.
