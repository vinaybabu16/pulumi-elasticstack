...
__all__ = [
    'ElasticsearchIngestProcessorSortResult',
    'AwaitableElasticsearchIngestProcessorSortResult',
    'elasticsearch_ingest_processor_sort',
    'elasticsearch_ingest_processor_sort_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorSortResult:
    """
...
class AwaitableElasticsearchIngestProcessorSortResult(ElasticsearchIngestProcessorSortResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorSortResult(
...
def elasticsearch_ingest_processor_sort(description: Optional[str] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorSortResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorSort:ElasticsearchIngestProcessorSort', __args__, opts=opts, typ=ElasticsearchIngestProcessorSortResult).value

    return AwaitableElasticsearchIngestProcessorSortResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_sort)
def elasticsearch_ingest_processor_sort_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorSortResult]:
    """
    Sorts the elements of an array ascending or descending. Homogeneous arrays of numbers will be sorted numerically, while arrays of strings or heterogeneous arrays of strings + numbers will be sorted lexicographically. Throws an error when the field is not an array.
