...
__all__ = [
    'ElasticsearchIngestProcessorScriptResult',
    'AwaitableElasticsearchIngestProcessorScriptResult',
    'elasticsearch_ingest_processor_script',
    'elasticsearch_ingest_processor_script_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorScriptResult:
    """
...
class AwaitableElasticsearchIngestProcessorScriptResult(ElasticsearchIngestProcessorScriptResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorScriptResult(
...
def elasticsearch_ingest_processor_script(description: Optional[str] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorScriptResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorScript:ElasticsearchIngestProcessorScript', __args__, opts=opts, typ=ElasticsearchIngestProcessorScriptResult).value

    return AwaitableElasticsearchIngestProcessorScriptResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_script)
def elasticsearch_ingest_processor_script_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                 ...
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorScriptResult]:
    """
    Runs an inline or stored script on incoming documents. The script runs in the ingest context.
