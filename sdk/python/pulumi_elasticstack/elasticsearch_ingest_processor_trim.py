...
__all__ = [
    'ElasticsearchIngestProcessorTrimResult',
    'AwaitableElasticsearchIngestProcessorTrimResult',
    'elasticsearch_ingest_processor_trim',
    'elasticsearch_ingest_processor_trim_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorTrimResult:
    """
...
class AwaitableElasticsearchIngestProcessorTrimResult(ElasticsearchIngestProcessorTrimResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorTrimResult(
...
def elasticsearch_ingest_processor_trim(description: Optional[str] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorTrimResult:
    """
    ...
    **NOTE:** This only works on leading and trailing whitespace.
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorTrim:ElasticsearchIngestProcessorTrim', __args__, opts=opts, typ=ElasticsearchIngestProcessorTrimResult).value

    return AwaitableElasticsearchIngestProcessorTrimResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_trim)
def elasticsearch_ingest_processor_trim_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorTrimResult]:
    """
    Trims whitespace from field. If the field is an array of strings, all members of the array will be trimmed.
