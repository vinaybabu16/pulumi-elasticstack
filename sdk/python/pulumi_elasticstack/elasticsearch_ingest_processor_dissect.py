...
__all__ = [
    'ElasticsearchIngestProcessorDissectResult',
    'AwaitableElasticsearchIngestProcessorDissectResult',
    'elasticsearch_ingest_processor_dissect',
    'elasticsearch_ingest_processor_dissect_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorDissectResult:
    """
...
class AwaitableElasticsearchIngestProcessorDissectResult(ElasticsearchIngestProcessorDissectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorDissectResult(
...
def elasticsearch_ingest_processor_dissect(append_separator: Optional[str] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorDissectResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorDissect:ElasticsearchIngestProcessorDissect', __args__, opts=opts, typ=ElasticsearchIngestProcessorDissectResult).value

    return AwaitableElasticsearchIngestProcessorDissectResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_dissect)
def elasticsearch_ingest_processor_dissect_output(append_separator: Optional[pulumi.Input[Optional[str]]] = None,
                                                  ...
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorDissectResult]:
    """
    Similar to the Grok Processor, dissect also extracts structured fields out of a single text field within a document. However unlike the Grok Processor, dissect does not use Regular Expressions. This allows dissect’s syntax to be simple and for some cases faster than the Grok Processor.
