...
__all__ = [
    'ElasticsearchIngestProcessorCommunityIdResult',
    'AwaitableElasticsearchIngestProcessorCommunityIdResult',
    'elasticsearch_ingest_processor_community_id',
    'elasticsearch_ingest_processor_community_id_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorCommunityIdResult:
    """
...
class AwaitableElasticsearchIngestProcessorCommunityIdResult(ElasticsearchIngestProcessorCommunityIdResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorCommunityIdResult(
...
def elasticsearch_ingest_processor_community_id(description: Optional[str] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorCommunityIdResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorCommunityId:ElasticsearchIngestProcessorCommunityId', __args__, opts=opts, typ=ElasticsearchIngestProcessorCommunityIdResult).value

    return AwaitableElasticsearchIngestProcessorCommunityIdResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_community_id)
def elasticsearch_ingest_processor_community_id_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                       ...
                                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorCommunityIdResult]:
    """
    Helper data source to which can be used to create a processor to compute the Community ID for network flow data as defined in the [Community ID Specification](https://github.com/corelight/community-id-spec).
    You can use a community ID to correlate network events related to a single flow.
