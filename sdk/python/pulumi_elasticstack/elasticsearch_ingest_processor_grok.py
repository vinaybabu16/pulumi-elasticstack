...
__all__ = [
    'ElasticsearchIngestProcessorGrokResult',
    'AwaitableElasticsearchIngestProcessorGrokResult',
    'elasticsearch_ingest_processor_grok',
    'elasticsearch_ingest_processor_grok_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorGrokResult:
    """
...
class AwaitableElasticsearchIngestProcessorGrokResult(ElasticsearchIngestProcessorGrokResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorGrokResult(
...
def elasticsearch_ingest_processor_grok(description: Optional[str] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorGrokResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorGrok:ElasticsearchIngestProcessorGrok', __args__, opts=opts, typ=ElasticsearchIngestProcessorGrokResult).value

    return AwaitableElasticsearchIngestProcessorGrokResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_grok)
def elasticsearch_ingest_processor_grok_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorGrokResult]:
    """
    Extracts structured fields out of a single text field within a document. You choose which field to extract matched fields from, as well as the grok pattern you expect will match. A grok pattern is like a regular expression that supports aliased expressions that can be reused.
