...
__all__ = [
    'ElasticsearchIngestProcessorFingerprintResult',
    'AwaitableElasticsearchIngestProcessorFingerprintResult',
    'elasticsearch_ingest_processor_fingerprint',
    'elasticsearch_ingest_processor_fingerprint_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorFingerprintResult:
    """
...
class AwaitableElasticsearchIngestProcessorFingerprintResult(ElasticsearchIngestProcessorFingerprintResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorFingerprintResult(
...
def elasticsearch_ingest_processor_fingerprint(description: Optional[str] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorFingerprintResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorFingerprint:ElasticsearchIngestProcessorFingerprint', __args__, opts=opts, typ=ElasticsearchIngestProcessorFingerprintResult).value

    return AwaitableElasticsearchIngestProcessorFingerprintResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_fingerprint)
def elasticsearch_ingest_processor_fingerprint_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                      ...
                                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorFingerprintResult]:
    """
    Computes a hash of the document’s content. You can use this hash for content fingerprinting.
