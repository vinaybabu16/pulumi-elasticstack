...
__all__ = [
    'ElasticsearchIngestProcessorUppercaseResult',
    'AwaitableElasticsearchIngestProcessorUppercaseResult',
    'elasticsearch_ingest_processor_uppercase',
    'elasticsearch_ingest_processor_uppercase_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorUppercaseResult:
    """
...
class AwaitableElasticsearchIngestProcessorUppercaseResult(ElasticsearchIngestProcessorUppercaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorUppercaseResult(
...
def elasticsearch_ingest_processor_uppercase(description: Optional[str] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorUppercaseResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorUppercase:ElasticsearchIngestProcessorUppercase', __args__, opts=opts, typ=ElasticsearchIngestProcessorUppercaseResult).value

    return AwaitableElasticsearchIngestProcessorUppercaseResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_uppercase)
def elasticsearch_ingest_processor_uppercase_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                    ...
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorUppercaseResult]:
    """
    Converts a string to its uppercase equivalent. If the field is an array of strings, all members of the array will be converted.
