...
__all__ = [
    'ElasticsearchIngestProcessorJsonResult',
    'AwaitableElasticsearchIngestProcessorJsonResult',
    'elasticsearch_ingest_processor_json',
    'elasticsearch_ingest_processor_json_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorJsonResult:
    """
...
class AwaitableElasticsearchIngestProcessorJsonResult(ElasticsearchIngestProcessorJsonResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorJsonResult(
...
def elasticsearch_ingest_processor_json(add_to_root: Optional[bool] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorJsonResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorJson:ElasticsearchIngestProcessorJson', __args__, opts=opts, typ=ElasticsearchIngestProcessorJsonResult).value

    return AwaitableElasticsearchIngestProcessorJsonResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_json)
def elasticsearch_ingest_processor_json_output(add_to_root: Optional[pulumi.Input[Optional[bool]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorJsonResult]:
    """
    Converts a JSON string into a structured JSON object.
