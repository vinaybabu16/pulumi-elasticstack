...
__all__ = ['ElasticsearchSnapshotLifecycleArgs', 'ElasticsearchSnapshotLifecycle']

@pulumi.input_type
class ElasticsearchSnapshotLifecycleArgs:
    def __init__(__self__, *,
                 repository: pulumi.Input[str],
                 schedule: pulumi.Input[str],
                 elasticsearch_connection: Optional[pulumi.Input['ElasticsearchSnapshotLifecycleElasticsearchConnectionArgs']] = None,
        ...
        :param pulumi.Input['ElasticsearchSnapshotLifecycleElasticsearchConnectionArgs'] elasticsearch_connection: Used to establish connection to Elasticsearch server. Overrides environment variables if present.
    ...
    def elasticsearch_connection(self) -> Optional[pulumi.Input['ElasticsearchSnapshotLifecycleElasticsearchConnectionArgs']]:
        """
    ...
    def elasticsearch_connection(self, value: Optional[pulumi.Input['ElasticsearchSnapshotLifecycleElasticsearchConnectionArgs']]):
...
@pulumi.input_type
class _ElasticsearchSnapshotLifecycleState:
    def __init__(__self__, *,
                 elasticsearch_connection: Optional[pulumi.Input['ElasticsearchSnapshotLifecycleElasticsearchConnectionArgs']] = None,
                 expand_wildcards: Optional[pulumi.Input[str]] = None,
                 expire_after: Optional[pulumi.Input[str]] = None,
...
class ElasticsearchSnapshotLifecycle(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 elasticsearch_connection: Optional[pulumi.Input[pulumi.InputType['ElasticsearchSnapshotLifecycleElasticsearchConnectionArgs']]] = None,
                 expand_wildcards: Optional[pulumi.Input[str]] = None,
                 expire_after: Optional[pulumi.Input[str]] = None,
                 feature_states: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ignore_unavailable: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ElasticsearchSnapshotLifecycleElasticsearchConnectionArgs']] elasticsearch_connection: Used to establish connection to Elasticsearch server. Overrides environment variables if present.
        :param pulumi.Input[str] expand_wildcards: Determines how wildcard patterns in the `indices` parameter match data streams and indices. Supports comma-separated values, such as `closed,hidden`.
        :param pulumi.Input[str] expire_after: Time period after which a snapshot is considered expired and eligible for deletion.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] feature_states: Feature states to include in the snapshot.
        :param pulumi.Input[bool] ignore_unavailable: If `false`, the snapshot fails if any data stream or index in indices is missing or closed. If `true`, the snapshot ignores missing or closed data streams and indices.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ElasticsearchSnapshotLifecycleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ElasticsearchSnapshotLifecycleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ElasticsearchSnapshotLifecycleArgs.__new__(ElasticsearchSnapshotLifecycleArgs)
        ...
        super(ElasticsearchSnapshotLifecycle, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            repository: Optional[pulumi.Input[str]] = None,
            schedule: Optional[pulumi.Input[str]] = None,
            snapshot_name: Optional[pulumi.Input[str]] = None) -> 'ElasticsearchSnapshotLifecycle':
        """
        ...
        __props__ = _ElasticsearchSnapshotLifecycleState.__new__(_ElasticsearchSnapshotLifecycleState)
        ...
        __props__.__dict__["schedule"] = schedule
        __props__.__dict__["snapshot_name"] = snapshot_name
        return ElasticsearchSnapshotLifecycle(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="elasticsearchConnection")
    def elasticsearch_connection(self) -> pulumi.Output[Optional['outputs.ElasticsearchSnapshotLifecycleElasticsearchConnection']]:
        """
        Used to establish connection to Elasticsearch server. Overrides environment variables if present.
        """
        return pulumi.get(self, "elasticsearch_connection")
