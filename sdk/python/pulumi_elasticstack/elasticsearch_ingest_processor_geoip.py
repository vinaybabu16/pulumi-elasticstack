...
__all__ = [
    'ElasticsearchIngestProcessorGeoipResult',
    'AwaitableElasticsearchIngestProcessorGeoipResult',
    'elasticsearch_ingest_processor_geoip',
    'elasticsearch_ingest_processor_geoip_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorGeoipResult:
    """
...
class AwaitableElasticsearchIngestProcessorGeoipResult(ElasticsearchIngestProcessorGeoipResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorGeoipResult(
...
def elasticsearch_ingest_processor_geoip(database_file: Optional[str] = None,
                                         field: Optional[str] = None,
                                         first_only: Optional[bool] = None,
                                         ignore_missing: Optional[bool] = None,
                                         properties: Optional[Sequence[str]] = None,
                                         target_field: Optional[str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorGeoipResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorGeoip:ElasticsearchIngestProcessorGeoip', __args__, opts=opts, typ=ElasticsearchIngestProcessorGeoipResult).value

    return AwaitableElasticsearchIngestProcessorGeoipResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_geoip)
def elasticsearch_ingest_processor_geoip_output(database_file: Optional[pulumi.Input[Optional[str]]] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorGeoipResult]:
    """
    The geoip processor adds information about the geographical location of an IPv4 or IPv6 address.
