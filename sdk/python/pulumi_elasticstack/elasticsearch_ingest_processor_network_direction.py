...
__all__ = [
    'ElasticsearchIngestProcessorNetworkDirectionResult',
    'AwaitableElasticsearchIngestProcessorNetworkDirectionResult',
    'elasticsearch_ingest_processor_network_direction',
    'elasticsearch_ingest_processor_network_direction_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorNetworkDirectionResult:
    """
...
class AwaitableElasticsearchIngestProcessorNetworkDirectionResult(ElasticsearchIngestProcessorNetworkDirectionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorNetworkDirectionResult(
...
def elasticsearch_ingest_processor_network_direction(description: Optional[str] = None,
                                                     ...
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorNetworkDirectionResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorNetworkDirection:ElasticsearchIngestProcessorNetworkDirection', __args__, opts=opts, typ=ElasticsearchIngestProcessorNetworkDirectionResult).value

    return AwaitableElasticsearchIngestProcessorNetworkDirectionResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_network_direction)
def elasticsearch_ingest_processor_network_direction_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                            ...
                                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorNetworkDirectionResult]:
    """
    Calculates the network direction given a source IP address, destination IP address, and a list of internal networks.
