...
__all__ = ['ElasticsearchIngestPipelineArgs', 'ElasticsearchIngestPipeline']

@pulumi.input_type
class ElasticsearchIngestPipelineArgs:
    def __init__(__self__, *,
                 processors: pulumi.Input[Sequence[pulumi.Input[str]]],
                 description: Optional[pulumi.Input[str]] = None,
                 elasticsearch_connection: Optional[pulumi.Input['ElasticsearchIngestPipelineElasticsearchConnectionArgs']] = None,
        ...
        :param pulumi.Input['ElasticsearchIngestPipelineElasticsearchConnectionArgs'] elasticsearch_connection: Used to establish connection to Elasticsearch server. Overrides environment variables if present.
    ...
    def elasticsearch_connection(self) -> Optional[pulumi.Input['ElasticsearchIngestPipelineElasticsearchConnectionArgs']]:
        """
    ...
    def elasticsearch_connection(self, value: Optional[pulumi.Input['ElasticsearchIngestPipelineElasticsearchConnectionArgs']]):
...
@pulumi.input_type
class _ElasticsearchIngestPipelineState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[str]] = None,
                 elasticsearch_connection: Optional[pulumi.Input['ElasticsearchIngestPipelineElasticsearchConnectionArgs']] = None,
...
class ElasticsearchIngestPipeline(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 elasticsearch_connection: Optional[pulumi.Input[pulumi.InputType['ElasticsearchIngestPipelineElasticsearchConnectionArgs']]] = None,
                 metadata: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 on_failures: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 processors: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
        ...
        :param pulumi.Input[str] description: Description of the ingest pipeline.
        :param pulumi.Input[pulumi.InputType['ElasticsearchIngestPipelineElasticsearchConnectionArgs']] elasticsearch_connection: Used to establish connection to Elasticsearch server. Overrides environment variables if present.
        :param pulumi.Input[str] metadata: Optional user metadata about the index template.
        :param pulumi.Input[str] name: The name of the ingest pipeline.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] on_failures: Processors to run immediately after a processor failure. Each processor supports a processor-level `on_failure` value. If a processor without an `on_failure` value fails, Elasticsearch uses this pipeline-level parameter as a fallback. The processors in this parameter run sequentially in the order specified. Elasticsearch will not attempt to run the pipeline’s remaining processors. See: https://www.elastic.co/guide/en/elasticsearch/reference/current/processors.html. Each record must be a valid JSON document
        :param pulumi.Input[Sequence[pulumi.Input[str]]] processors: Processors used to perform transformations on documents before indexing. Processors run sequentially in the order specified. See: https://www.elastic.co/guide/en/elasticsearch/reference/current/processors.html. Each record must be a valid JSON document.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ElasticsearchIngestPipelineArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ElasticsearchIngestPipelineArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ElasticsearchIngestPipelineArgs.__new__(ElasticsearchIngestPipelineArgs)
        ...
        super(ElasticsearchIngestPipeline, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            on_failures: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            processors: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'ElasticsearchIngestPipeline':
        """
        ...
        __props__ = _ElasticsearchIngestPipelineState.__new__(_ElasticsearchIngestPipelineState)
        ...
        __props__.__dict__["on_failures"] = on_failures
        __props__.__dict__["processors"] = processors
        return ElasticsearchIngestPipeline(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="elasticsearchConnection")
    def elasticsearch_connection(self) -> pulumi.Output[Optional['outputs.ElasticsearchIngestPipelineElasticsearchConnection']]:
        """
        Used to establish connection to Elasticsearch server. Overrides environment variables if present.
        """
        return pulumi.get(self, "elasticsearch_connection")
