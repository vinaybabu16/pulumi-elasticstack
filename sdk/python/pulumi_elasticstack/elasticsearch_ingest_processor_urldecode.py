...
__all__ = [
    'ElasticsearchIngestProcessorUrldecodeResult',
    'AwaitableElasticsearchIngestProcessorUrldecodeResult',
    'elasticsearch_ingest_processor_urldecode',
    'elasticsearch_ingest_processor_urldecode_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorUrldecodeResult:
    """
...
class AwaitableElasticsearchIngestProcessorUrldecodeResult(ElasticsearchIngestProcessorUrldecodeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorUrldecodeResult(
...
def elasticsearch_ingest_processor_urldecode(description: Optional[str] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorUrldecodeResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorUrldecode:ElasticsearchIngestProcessorUrldecode', __args__, opts=opts, typ=ElasticsearchIngestProcessorUrldecodeResult).value

    return AwaitableElasticsearchIngestProcessorUrldecodeResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_urldecode)
def elasticsearch_ingest_processor_urldecode_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                    ...
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorUrldecodeResult]:
    """
    URL-decodes a string. If the field is an array of strings, all members of the array will be decoded.
