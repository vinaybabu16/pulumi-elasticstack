...
__all__ = [
    'ElasticsearchIngestProcessorCsvResult',
    'AwaitableElasticsearchIngestProcessorCsvResult',
    'elasticsearch_ingest_processor_csv',
    'elasticsearch_ingest_processor_csv_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorCsvResult:
    """
...
class AwaitableElasticsearchIngestProcessorCsvResult(ElasticsearchIngestProcessorCsvResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorCsvResult(
...
def elasticsearch_ingest_processor_csv(description: Optional[str] = None,
                                       ...
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorCsvResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorCsv:ElasticsearchIngestProcessorCsv', __args__, opts=opts, typ=ElasticsearchIngestProcessorCsvResult).value

    return AwaitableElasticsearchIngestProcessorCsvResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_csv)
def elasticsearch_ingest_processor_csv_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                              ...
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorCsvResult]:
    """
    Helper data source to which can be used to extract fields from CSV line out of a single text field within a document. Any empty field in CSV will be skipped.
