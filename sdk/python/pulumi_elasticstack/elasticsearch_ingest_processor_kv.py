...
__all__ = [
    'ElasticsearchIngestProcessorKvResult',
    'AwaitableElasticsearchIngestProcessorKvResult',
    'elasticsearch_ingest_processor_kv',
    'elasticsearch_ingest_processor_kv_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorKvResult:
    """
...
class AwaitableElasticsearchIngestProcessorKvResult(ElasticsearchIngestProcessorKvResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorKvResult(
...
def elasticsearch_ingest_processor_kv(description: Optional[str] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorKvResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorKv:ElasticsearchIngestProcessorKv', __args__, opts=opts, typ=ElasticsearchIngestProcessorKvResult).value

    return AwaitableElasticsearchIngestProcessorKvResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_kv)
def elasticsearch_ingest_processor_kv_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorKvResult]:
    """
    This processor helps automatically parse messages (or specific event fields) which are of the `foo=bar` variety.
