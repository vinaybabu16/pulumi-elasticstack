...
__all__ = [
    'ElasticsearchIngestProcessorUriPartsResult',
    'AwaitableElasticsearchIngestProcessorUriPartsResult',
    'elasticsearch_ingest_processor_uri_parts',
    'elasticsearch_ingest_processor_uri_parts_output',
]

@pulumi.output_type
class ElasticsearchIngestProcessorUriPartsResult:
    """
...
class AwaitableElasticsearchIngestProcessorUriPartsResult(ElasticsearchIngestProcessorUriPartsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ElasticsearchIngestProcessorUriPartsResult(
...
def elasticsearch_ingest_processor_uri_parts(description: Optional[str] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableElasticsearchIngestProcessorUriPartsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('elasticstack:index/elasticsearchIngestProcessorUriParts:ElasticsearchIngestProcessorUriParts', __args__, opts=opts, typ=ElasticsearchIngestProcessorUriPartsResult).value

    return AwaitableElasticsearchIngestProcessorUriPartsResult(
...
@_utilities.lift_output_func(elasticsearch_ingest_processor_uri_parts)
def elasticsearch_ingest_processor_uri_parts_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                                    ...
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ElasticsearchIngestProcessorUriPartsResult]:
    """
    Parses a Uniform Resource Identifier (URI) string and extracts its components as an object. This URI object includes properties for the URI’s domain, path, fragment, port, query, scheme, user info, username, and password.
